...
void iterate(const size_t, const double *restrict, const double *restrict,
             double *restrict);
void usage(char **);
...
void iterate(const size_t n, const double *restrict b,
             const double *restrict s, double *restrict a)
{
    size_t i, j, k;
