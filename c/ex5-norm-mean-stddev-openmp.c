...
double std(const size_t, const size_t, const double,
...
double *normrnd(const size_t n, const size_t m, const double mu,
                const double sigma)
{
...
double std(const size_t n, const size_t m, const double avg,
