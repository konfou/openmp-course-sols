...
void jacobi(std::vector<double>&, const std::vector<double>&,
            const struct Opts);
double residual(const std::vector<double>&,
                const std::vector<double>&, const struct Opts);
void output(const std::vector<double>&, const std::vector<double>&,
            const size_t);
...
void jacobi(std::vector<double>& u, const std::vector<double>& rho,
            const struct Opts o)
{
...
double residual(const std::vector<double>& u,
                const std::vector<double>& rho, const struct Opts o)
{
    double eqn, res = 0;
    size_t j;
...
void output(const std::vector<double>& u,
            const std::vector<double>& rho, const size_t n)
{
